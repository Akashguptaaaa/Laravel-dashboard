...
@section('content')
	<div class="col-lg-12">
		<div class="card card-default">
			...
			<div class="card-body">
				<form  action="{{ route('update.product') }}" method="post" id="categoryForm">
					@csrf
					...
					<div class="form-row">
						...
						<div class="col-md-12 mb-3">
							...
							<div class="form-group">
								<select class="js-example-basic form-control" name="category_id" id="validationServer01">
									...
									<option value="{{$cagtegory->id}}" @if($cagtegory->id == $product->category_id) selected @endif>{{$cagtegory->category_name}}</option>
									@endforeach
						...
						<div class="col-md-12 mb-3">
							...
							<input type="text" class="form-control is-valid" id="validationServer02" name="product_name" placeholder="Product Name" value="{{$product->product_name}}">
						</div>

						<div class="col-md-12 mb-3">
							<label for="validationServer03">Product Description</label>
							<input type="text" class="form-control is-valid" id="validationServer03" name="product_description" placeholder="Product Description" value="{{$product->product_description}}">
						</div>

						<div class="col-md-12 mb-3">
							<label for="validationServer04">Product Price</label>
							<input type="text" class="form-control is-valid" id="validationServer04" name="product_price" placeholder="Product Price" value="{{$product->product_price}}">
						</div>
                        
                        
                       @if(isset($products->ProductFeature))  
                       	@foreach($products->ProductFeature as $key=>$col)
                       <div class="row">
							<div class="col-md-4 mb-3">
								<label for="validationServer05">Product Color</label>
								<input type="text" class="form-control is-valid" id="validationServer05" name="product_color[]" placeholder="Product Color" value="{{$col->product_color}}">
							</div>
					
							<div class="col-md-4 mb-3">
								<label for="validationServer06">Product Size</label>
								<input type="text" class="form-control is-valid" id="validationServer06" name="product_size[]" placeholder="Product Size" value="{{$col->product_size}}">
							</div>
