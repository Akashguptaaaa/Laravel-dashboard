...
@section('content')
	<div class="col-lg-12">
		<div class="card card-default">
			...
			<div class="card-body">
				<form  action="{{ route('update.category') }}" method="post" id="categoryForm">
					@csrf
					...
					<div class="form-row">
						<div class="col-md-12 mb-3">
							...
							<input type="text" class="form-control is-valid" id="validationServer01" name="category_name" placeholder="Category Name" value="{{$category->category_name}}">
						</div>
						...
						<div class="col-md-12 mb-3">
							...
							<div class="form-group">
								<select class="js-example-basic form-control" name="status">
									...
									<option value="0"  @if($category->status == 0) selected @endif>De-Active</option>
								</select>
							</div>
						</div>
